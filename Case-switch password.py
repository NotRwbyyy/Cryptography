...
def options():
    meow = "Mercy) Please enter one of the following options: "
...
def database_path():
    name = input("Mercy) Please enter the name of the database: ").strip().lower()
...
def main():
    ...
    msg = "Welcome to Mercy Account System Manager"
    ...
    while True: 
        ...
        lines = [
            ...
            "2) Create a new password that will be hashed",
            "3) Account Services Menu",
            "4) Exit program"
        ]
        for line in lines:
            for ch in line:
        ...
        match choice:
            ...
            case "2":
                if not new_user:
                    print("Mercy) Please enter a username first (option 1).")
                    continue
